...
class AutoGPT_Zapier(AutoGPTPluginTemplate):
    """
    This is a plugin to Zapier Webhooks for Auto-GPT
    """
    ...
    def __init__(self):
        ...
        self._name = "AutoGPT-Zapier"
        self._version = "0.1.0"
        self._description = "AutoGPT Zapier Webhooks integration."

        with open(str(Path(os.getcwd()) / ".env"), "r", encoding="utf=8") as fp:
            load_dotenv(stream=fp)

        self.zapier_trigger = os.getenv("ZAPIER_WEBHOOK_ENDPOINT")
